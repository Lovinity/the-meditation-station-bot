...
module.exports = class extends Event {
    ...
    run(guildMember) {
        ...
        if (_temp.length > 0)
        {
            ...
            if (_channel2)
            {
                _channel2.send(`**Welcome new member** <@${guildMember.id}>! It looks like you've never been here before. Be sure to check out the welcome channel for the rules. Use the \`!staff\` command if you ever need to talk with staff in private. We hope you enjoy your stay!`);
            }
        }
